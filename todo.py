...
#  # CRUD => Create, Read, Update, Delete
 # Step
 #  # python => python -V or python --version # pip list => display all the dependency of python # mysql => pip install mysql-connector-python # connect => connection, method # cursor => cursor => cursor object # execute => execute the query 
...
for i in cursor:
   print(i) 
   # print("Table created...") # insert data
while True:
     print("\n Task Management")
     print("1. Add Task")
     print("2. View Task")
